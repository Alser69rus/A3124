Public Class aseApparatsType
    ...
    Private Sub aseApparatsType_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub PanelDraw()
        If ListBox1.Items.Count > 10 Then
            ...
            If ListBox1.Items.Count > 1 Then
                i = 350 * ListBox1.SelectedIndex / (ListBox1.Items.Count - 1)
            Else
                i = 0
            End If
    ...
    Private Sub ApparatTypeBindingSource_DataSourceChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ApparatTypeBindingSource.DataSourceChanged
        PanelDraw()
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        ...
        If frm.ShowDialog = Windows.Forms.DialogResult.OK Then
            Dim row As GidrogasitelDataSet.ApparatTypeRow = GidrogasitelDataSet.ApparatType.NewApparatTypeRow
            row.Name = frm.btnResult.Text
            GidrogasitelDataSet.ApparatType.AddApparatTypeRow(row)
    ...
    Private Sub btnDel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDel.Click
        Dim row As GidrogasitelDataSet.ApparatTypeRow = GidrogasitelDataSet.ApparatType.FindByID(ListBox1.Tag)
        row.Delete()
        ApparatTypeTableAdapter.Update(GidrogasitelDataSet.ApparatType)
