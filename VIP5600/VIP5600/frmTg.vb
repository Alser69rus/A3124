Public Class frmTg
    ...
    Private Sub btnOk_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnOk.Click
        frmGMain.stend.rw.T_MIN_GIDRO = t1
        frmGMain.stend.rw.T_MAX_GIDRO = t2
        frmGMain.stend.rw.U_MIN_GIDRO = u1
        frmGMain.stend.rw.U_T_GIDRO = u2
    ...
    Public Sub New()
        ...
        t1 = frmGMain.stend.rw.T_MIN_GIDRO
        t2 = frmGMain.stend.rw.T_MAX_GIDRO
        u1 = frmGMain.stend.rw.U_MIN_GIDRO
        u2 = frmGMain.stend.rw.U_T_GIDRO
    ...
    Public Sub refreshT(ByRef Ch0() As Short)
        ...
        t = frmGMain.opros.Tgidro.GetValue(1, False)
        btnT.Text = "t=" & t & " °C"
        btnU.Text = "U=" & u & " В"
